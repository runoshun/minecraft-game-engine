...
The output directory is the deployment artifact. Copy it into a Minecraft world's `datapacks/` directory and reload. Generated directories carry `.mcgame-portable-generated`; the CLI refuses to overwrite a non-empty directory without that marker.
