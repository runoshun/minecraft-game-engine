...
For a tagged release such as `v0.2.1`, the stable download shape is `https://github.com/runoshun/minecraft-game-engine/releases/download/v0.2.1/mc-game-runtime-0.2.1.jar`.
