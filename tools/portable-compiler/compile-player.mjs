...
import { formPlayerInitLines } from "./compile-form.mjs";
...
function collectActionPlayerSets(actions, out) {
  for (const action of actions) {
    ...
    if (action.op === "interaction_use" || action.op === "interaction_controller_player") out.set("all_online", "all_online");
...
export function compilePlayerLoad(program, lines, ctx) {
  ...
  init.push(...formPlayerInitLines(program, ctx));
